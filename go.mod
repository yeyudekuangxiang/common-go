...
require (
	...
	gitlab.miotech.com/miotech-application/backend/mp2c-micro v1.11.1
...
replace gitlab.miotech.com/miotech-application/backend/mp2c-micro  v1.11.1 => gitlab.miotech.com/miotech-application/backend/mp2c-micro.git v1.11.1
