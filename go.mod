...
require (
	...
	gitlab.miotech.com/miotech-application/backend/common-go v1.1.59
	gitlab.miotech.com/miotech-application/backend/mp2c-micro v1.10.2
...
replace gitlab.miotech.com/miotech-application/backend/mp2c-micro v1.10.2 => gitlab.miotech.com/miotech-application/backend/mp2c-micro.git v1.10.2

replace gitlab.miotech.com/miotech-application/backend/common-go v1.1.59 => gitlab.miotech.com/miotech-application/backend/common-go.git v1.1.59
