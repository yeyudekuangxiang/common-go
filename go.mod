...
require (
	...
	gitlab.miotech.com/miotech-application/backend/mp2c-micro v1.2.1-develop
...
replace gitlab.miotech.com/miotech-application/backend/mp2c-micro v1.2.1-develop => gitlab.miotech.com/miotech-application/backend/mp2c-micro.git v1.2.1-develop
