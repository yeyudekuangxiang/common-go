...
require (
	...
	gitlab.miotech.com/miotech-application/backend/common-go v1.2.30
...
replace gitlab.miotech.com/miotech-application/backend/common-go v1.2.30 => gitlab.miotech.com/miotech-application/backend/common-go.git v1.2.30
