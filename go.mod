...
require (
	...
	gitlab.miotech.com/miotech-application/backend/common-go v1.0.7
	gitlab.miotech.com/miotech-application/backend/mp2c-micro v1.3.0
...
replace gitlab.miotech.com/miotech-application/backend/mp2c-micro v1.3.0 => gitlab.miotech.com/miotech-application/backend/mp2c-micro.git v1.3.0
