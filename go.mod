...
require (
	...
	gitlab.miotech.com/miotech-application/backend/common-go v1.2.28
...
replace gitlab.miotech.com/miotech-application/backend/common-go v1.2.28 => gitlab.miotech.com/miotech-application/backend/common-go.git v1.2.28
