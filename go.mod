...
require (
	...
	gitlab.miotech.com/miotech-application/backend/common-go v1.1.2
	gitlab.miotech.com/miotech-application/backend/mp2c-micro v1.9.0
...
replace gitlab.miotech.com/miotech-application/backend/mp2c-micro v1.9.0 => gitlab.miotech.com/miotech-application/backend/mp2c-micro.git v1.9.0

replace gitlab.miotech.com/miotech-application/backend/common-go v1.1.2 => gitlab.miotech.com/miotech-application/backend/common-go.git v1.1.2
