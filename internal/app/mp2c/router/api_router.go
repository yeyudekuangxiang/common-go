...
func apiRouter(router *gin.Engine) {
	...
	mustAuthRouter.Use(middleware.MustAuth(), middleware.Throttle())
	{
		...
		topicRouter := mustAuthRouter.Group("/topic")
		{
			...
			topicRouter.GET("/activities/signup-path", apiutil.FormatRender(community.DefaultTopicController.ExportSignupList))
		}
		...
		{
			//	carbonRouter.POST("/create", apiutil.Format(api.DefaultCarbonController.Save))
