...
func Router() {
	...
	StartConsume("smsqueue", "sms-exchange", []string{routerkey.WxWorkRobot}, false, smscsr.SendSms)
	StartConsume("zhugequeue", "zhuge-exchange", []string{routerkey.WxWorkRobot}, false, zhugecsr.SendToZhuge)
}
