...
func (srv QuizDailyResultService) IsAnsweredToday(openId string, day timetool.Date) (bool, error) {
	result, err := srv.FindTodayResult(openId, day)
	return result.ID != 0, err
}
func (srv QuizDailyResultService) FindTodayResult(openId string, day timetool.Date) (*entity.QuizDailyResult, error) {
...
func (srv QuizDailyResultService) CompleteTodayQuiz(openid string, t timetool.Time) (*entity.QuizDailyResult, error) {
