...
func NewJinHuaXingService(ctx *context.MioContext) *JinHuaXingService {
	return &JinHuaXingService{
		ctx:    ctx,
...
// GetSign 签名
func (srv JinHuaXingService) getSign(params map[string]interface{}) string {
	var slice []string
	for k := range params {
