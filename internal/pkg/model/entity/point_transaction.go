...
func (p PointTransactionType) Text() string {
	...
	case POINT_POWER_REPLACE:
		return "新能源换电"
	case POINT_OLDSTUFF_RECYCLING_CLOTHING, POINT_OLDSTUFF_RECYCLING_DIGITAL, POINT_OLDSTUFF_RECYCLING_APPLIANCE, POINT_OLDSTUFF_RECYCLING_BOOK:
		return "旧物回收"
...
const (
	...
	POINT_OLDSTUFF_RECYCLING_CLOTHING  PointTransactionType = "OLDSTUFF_RECYCLING_CLOTHING"  //旧物回收 衣物鞋帽
	POINT_OLDSTUFF_RECYCLING_DIGITAL   PointTransactionType = "OLDSTUFF_RECYCLING_COMPUTER"  //旧物回收 数码
	POINT_OLDSTUFF_RECYCLING_APPLIANCE PointTransactionType = "OLDSTUFF_RECYCLING_APPLIANCE" //旧物回收 家电
	POINT_OLDSTUFF_RECYCLING_BOOK      PointTransactionType = "OLDSTUFF_RECYCLING_BOOK"      //旧物回收 书籍
...
var PointTransactionTypeList = []PointTransactionType{
	...
	POINT_OLDSTUFF_RECYCLING_CLOTHING,
	POINT_OLDSTUFF_RECYCLING_DIGITAL,
	POINT_OLDSTUFF_RECYCLING_APPLIANCE,
	POINT_OLDSTUFF_RECYCLING_BOOK,
