...
const (
	...
	POINT_OLDSTUFF_RECYCLING      PointTransactionType = "OLDSTUFF_RECYCLING" //旧物回收
...
var PointCollectLimitMap = map[PointTransactionType]int{
	...
	POINT_ARTICLE:            2, //	次/天
	POINT_OLDSTUFF_RECYCLING: 1, //	次/天
}
